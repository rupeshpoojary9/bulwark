"""Score the ToxicityValidator against a labeled dataset.

Run:  python -m evals.eval_toxicity
Prints precision / recall / F1 / false-positive-rate and a confusion matrix.
The "grass"/"class"/"assistant" negatives guard against naive substring matching.
"""
